...
library(CytobankAPI)
library(cytotidyr)
token <- "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..7pS28qHB4mTM-feDEEIRRqgBKTKHvoKXelj3QHJjeSI"
?authenticate
cyto_session <- authenticate("vanderbilt", username = "reismab", 
                             password = "oligomycin1")
experiment.id <- 29560
