...
#' @param input A \code{\link[flowCore:flowFrame-class]{flowCore::flowFrame}} or tibble with the original channel names as the shortNames or columns (respectively).
#' @param exp_info A cytobank experiment info object generated by \code{\link{fetchCytobankExperiment}}
